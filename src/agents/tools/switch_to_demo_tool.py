...
class SwitchToDemoTool(BaseModel):
    """
    Используй этот инструмент, если пользователь согласился на демонстрацию, хочет попробовать демо-режим или посмотреть симуляцию а ты уже спросила название компании.
